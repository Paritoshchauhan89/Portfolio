        ...
        <div className="row">
          <div className="col-lg-6">
            ...
            <div className="resume-item pb-0">
              ...
              <ul>
                <li>Shain Vihar Ghaziabad In U.P ( Pincode - 201009)</li>
            ...
            <div className="resume-item">
              ...
              <p>I am pursuing my MCA(1st Year) from Hi-Tech college in 2025, Here I learned How Smart contracts work and the Deep knowledge of WEB3 And many thing that help me in present</p>
            </div>
            <div className="resume-item">
